...
draft-pidlisnyi-aps-03 section 3.3 ("Chain Verification") states the rule this
module gives an interface: "Each action selects one root-to-leaf authority
chain.  A verifier MUST NOT union scopes or budgets from multiple chains."
That half is required behaviour and ships as a stable root export. The fallback
surface in :func:`select_with_fallback` is PROPOSED and has no counterpart in
draft-03; every symbol carrying it says so.
